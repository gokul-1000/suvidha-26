...
import { Plus, Settings, Trash2, CreditCard, Search, Zap } from "lucide-react";
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        >
          ...
          <ul className="space-y-2 text-blue-800">
            ...
            <li>
              • Documents can be uploaded via DigiLocker or mobile QR scan
            </li>
            <li>
              • Track your application status anytime with your application
              number
            </li>
          </ul>
        </motion.div>
